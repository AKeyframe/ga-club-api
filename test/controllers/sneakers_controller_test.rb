...
class SneakersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sneaker" do
    assert_difference('Sneaker.count') do
      post sneakers_url, params: { sneaker: { brand: @sneaker.brand, cart: @sneaker.cart, description: @sneaker.description, image: @sneaker.image, name: @sneaker.name, price: @sneaker.price } }, as: :json
    end
  ...
  test "should update sneaker" do
    patch sneaker_url(@sneaker), params: { sneaker: { brand: @sneaker.brand, cart: @sneaker.cart, description: @sneaker.description, image: @sneaker.image, name: @sneaker.name, price: @sneaker.price } }, as: :json
    assert_response 200
  end
